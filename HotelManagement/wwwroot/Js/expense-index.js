...
$(document).ready(function() {
    ...
    $('#btnToday').on('click', function() {
        ...
        updateDateInputsState();
        expenseState.startDate = todayStr;
        expenseState.endDate = todayStr;
    ...
    $('#btnYesterday').on('click', function() {
        ...
        $('#chkEnableDateRange').prop('checked', true);
        updateDateInputsState();
        expenseState.startDate = dateStr;
        expenseState.endDate = dateStr;
    ...
    $('#btnMonth').on('click', function() {
        ...
        $('#chkEnableDateRange').prop('checked', true);
        updateDateInputsState();
        expenseState.startDate = firstDayStr;
        expenseState.endDate = lastDayStr;
...
function checkAndHighlightActiveDateButton() {
    ...
    if (startDate === monthFirstDay && endDate === monthLastDay) {
        setDateButtonActive('btnMonth');
        return;
    }
    ...
    if (startDate === yearFirstDay && endDate === yearLastDay) {
        setDateButtonActive('btnYear');
        return;
    }
